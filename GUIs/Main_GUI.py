...
def make_window():
    ...
    layout = [[sg.Input('', key='ephy_file_input', size=(30,2), visible=False, enable_events=True), sg.FileBrowse("Load ephy file", k="Load_ephy_file", button_color='red', enable_events=True),
              ...
              [sg.B('Launch Sorting', k='launch_sorting_button', ), sg.B('print_sorter_param_dict', k='print_sorter_param_dict', )]
             ]
