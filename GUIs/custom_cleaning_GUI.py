...
def make_config_custom_cleaning_param_window(custom_cleaning_param, default_input_size=(5,2)):
    ...
    split_multi_unit_layout = [[sg.T('Activate', tooltip='If selected will split units containing 2 or more population of spikes waveform profil'), sg.Checkbox('', default=custom_cleaning_param['split_multi_unit']['activate'], k=('split_multi_unit', 'activate'), tooltip='If selected will split units containing 2 or more population of spikes waveform profil')],
                               ...
                               [sg.T('number of Component', tooltip='Number of component used to compare cluster'), sg.I(custom_cleaning_param['split_multi_unit']['n_component'], k=('split_multi_unit', 'n_component'), size=default_input_size, tooltip='Number of component used to compare cluster')],
    ...
    remove_by_metric_layout = [[sg.T('Activate', tooltip='Remove bad unit using metrics'), sg.Checkbox('', default=custom_cleaning_param['remove_by_metric']['activate'], k=('remove_by_metric', 'activate'), tooltip='Remove bad unit using metrics')],
                               ...
                               [sg.T('Minimum frequency', tooltip='Minimum frequency that a unit must have to be selected'), sg.Checkbox('', default=custom_cleaning_param['remove_by_metric']['min_freq_activate'], k=('remove_by_metric', 'min_freq_activate'), tooltip='Minimum frequency that a unit must have to be selected'),
                                sg.I(custom_cleaning_param['remove_by_metric']['min_freq_threshold_hz_low'], k=('remove_by_metric', 'min_freq_threshold_hz_low'), tooltip='Minimum frequency that a unit must have to be selected', size=default_input_size),
                                sg.T('-'), sg.I(custom_cleaning_param['remove_by_metric']['min_freq_threshold_hz_high'], k=('remove_by_metric', 'min_freq_threshold_hz_high'), tooltip='Minimum frequency that a unit must have to be selected', size=default_input_size), sg.T('Hz')],
                               
                               [sg.T('Presence ratio', tooltip='Presence ratio is the proportion of discrete time bins in which at least one spike occurred. Each unit must be above the treshold to be selected.'), sg.Checkbox('', default=custom_cleaning_param['remove_by_metric']['presence_ratio_activate'], k=('remove_by_metric', 'presence_ratio_activate'), tooltip='Presence ratio is the proportion of discrete time bins in which at least one spike occurred. Each unit must be above the treshold to be selected.'),
                                sg.I(custom_cleaning_param['remove_by_metric']['presence_ratio_threshold_low'], k=('remove_by_metric', 'presence_ratio_threshold_low'), tooltip='Presence ratio is the proportion of discrete time bins in which at least one spike occurred. Each unit must be above the treshold to be selected.', size=default_input_size),
                                sg.T('-'), sg.I(custom_cleaning_param['remove_by_metric']['presence_ratio_threshold_high'], k=('remove_by_metric', 'presence_ratio_threshold_high'), tooltip='Presence ratio is the proportion of discrete time bins in which at least one spike occurred. Each unit must be above the treshold to be selected.', size=default_input_size),],
                               
                               [sg.T('L-ratio', tooltip='This metric identifies unit separation, a high value indicates a highly contaminated unit. Each unit must be below the treshold to be selected.'), sg.Checkbox('', default=custom_cleaning_param['remove_by_metric']['L_ratio_activate'], k=('remove_by_metric', 'L_ratio_activate'), tooltip='This metric identifies unit separation, a high value indicates a highly contaminated unit. Each unit must be below the treshold to be selected.'),
                               sg.I(custom_cleaning_param['remove_by_metric']['L_ratio_threshold'], k=('remove_by_metric', 'L_ratio_threshold'), tooltip='This metric identifies unit separation, a high value indicates a highly contaminated unit. Each unit must be below the treshold to be selected.', size=default_input_size)],
